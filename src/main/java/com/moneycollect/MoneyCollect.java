package com.moneycollect;

import java.net.PasswordAuthentication;
import java.net.Proxy;
import java.util.HashMap;
import java.util.Map;
public abstract class MoneyCollect {
    public static final int DEFAULT_CONNECT_TIMEOUT = 30 * 1000;
    public static final int DEFAULT_READ_TIMEOUT = 80 * 1000;

    public static final String API_VERSION = "2021-10-01";

    public static final String LIVE_API_BASE = "https://api.moneycollect.com/api/services";
    ...
    /**
     * Set proxy to tunnel all MoneyCollect connections.
     *
    ...
    /**
     * Sets information about your application. The information is passed along to MoneyCollect.
     *
